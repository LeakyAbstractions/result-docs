...
- [🚀 Advanced Usage](docs/advanced/README.md)
  ...
  - [Transforming Results](docs/advanced/transforming.md)
- [🏁 Recap](docs/recap.md)
...
## Other resources <a href="#extra" id="extra"></a>

- [📦 Bill of Materials](extra/bom.md)
- [📈 Benchmarks](extra/benchmarks.md)
- [🤖 Demo Projects](extra/demo/README.md)
  - [Spring Boot Demo Project](extra/demo/spring-boot.md)
  - [Micronaut Demo Project](extra/demo/micronaut.md)
- [⚖️ License](extra/license.md)
